                    ...
                    <div class="row" data-sticky-container>
                        <div class="track-panel">
                            <div class="track-content">
                                <section id="overview">
                                    <h3>Overview</h3>
                                    <img class="mb30 img-fluid" src="{{ "assets/img/FundamentalsOfMEANStackDevelopment-cover.png" | relative_url }}" alt="O&B instructor writing on whiteboard teaches his class about the full stack javascript. | MEAN Stack Development Training Philippines ">
