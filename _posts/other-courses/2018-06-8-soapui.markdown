...
desc:               "SOAP UI Training Philippines | Web services APIs are ubiquitous in modern enterprise applications, and SoapUI is the most popular tool for automating the testing of web services APIs."
description:        SOAP UI Training Philippines | Web services APIs are ubiquitous in modern enterprise applications, and SoapUI is the most popular tool for automating the testing of web services APIs.
...
short_description:  SOAP UI Training Philippines | Web services APIs are ubiquitous in modern enterprise applications, and SoapUI is the most popular tool for automating the testing of web services APIs.
                    ...
                    <div class="row" data-sticky-container>
                        <div class="track-panel">
                            <div class="track-content">
                                <section id="overview">
                                    <h3>Overview</h3>
                                    <img class="mb30 img-fluid" src="{{ "assets/img/WebServicesAPITestingWithSoapUI-cover.png" | relative_url }}" alt="Students in front of their computer monitors are running basic tests. | SOAP UI Training Philippines">
