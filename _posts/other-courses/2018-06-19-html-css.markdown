...
titles:             O&B HTML / CSS
desc:               " HTML and CSS Training Philippines | This training course will cover an introduction of HTML and CSS, along with a brief introduction of Javascript and Bootstrap."
description:        HTML and CSS Training Philippines | This training course will cover an introduction of HTML and CSS, along with a brief introduction of Javascript and Bootstrap.
...
short_description:   HTML and CSS Training Philippines | This training course will cover an introduction of HTML and CSS, along with a brief introduction of Javascript and Bootstrap.
image:              assets/img/course-html.png
alt:                HTML5 logo and CSS3 Logo | HTML and CSS Training Philippines | Orange and Bronze Software Labs.
                    ...
                    <div class="row" data-sticky-container>
                        <div class="track-panel">
                            <div class="track-content">
                                <section id="overview">
                                    <h3>Overview</h3>
                                    <img class="mb30 img-fluid" src="{{ "assets/img/HTML-CSS-cover.png" | relative_url }}" alt="Students in front of their computer that shows some HTML and CSS code on screen. | HTML CSS Training Philippines">
