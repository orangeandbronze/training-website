...
titles:             "O&B Mongo DB"
desc:               "Mongo DB Training Philippines | MongoDB is a popular non-SQL database that stores data as JSON-like documents. Schemas need not be defined upfront, providing developers with flexibility when dealing with often-changing data models. It is designed to easily support sharding (horizontal partitioning)."
description:        Mongo DB Training Philippines | MongoDB is a popular non-SQL database that stores data as JSON-like documents. Schemas need not be defined upfront, providing developers with flexibility when dealing with often-changing data models. It is designed to easily support sharding (horizontal partitioning).
...
short_description:  Mongo DB Training Philippines | MongoDB is a popular non-SQL database that stores data as JSON-like documents.
