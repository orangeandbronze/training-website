...
description:        This course is an introduction to Java and the most commonly used libraries of the Java Standard Edition (Java SE). Covers Java 8.
photo:              "https://university.orangeandbronze.com/assets/img/CoreJavaAndCommonlyUsedLibraries-FBLinkPostPhoto.png"
short_description:  This course is an introduction to Java and the most commonly used libraries of the Java Standard Edition (Java SE). Covers Java 8.
